...
EnvironmentlistCommand::EnvironmentlistCommand(Command & parent) : Command(parent, "environmentlist") {
...
void EnvironmentlistCommand::run() {
    ...
    libdnf::cli::output::print_environmentlist_table(environment_list);
}
